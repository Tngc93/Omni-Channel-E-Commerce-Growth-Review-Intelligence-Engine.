...
import { Sparkles, Layers, Github, ExternalLink } from 'lucide-react';
        ...
        <Link href="/" className="flex items-center gap-2.5 group">
          ...
          <div>
            <div className="text-sm font-semibold tracking-tight text-white flex items-center gap-1.5">
              <span>ReviewIQ</span>
              <span className="text-[10px] uppercase font-mono px-1.5 py-0.5 rounded bg-emerald-500/10 text-emerald-400 border border-emerald-500/20">Omni-Channel</span>
            </div>
            <p className="text-[10px] text-slate-400 font-medium">Universal E-Commerce Growth & Review Intelligence</p>
          </div>
        </Link>

        <div className="hidden lg:flex items-center gap-2 pl-4 border-l border-white/[0.08]">
          <Badge variant="cyan">Consumer Tech</Badge>
          <Badge variant="purple">Fashion & Apparel</Badge>
          <Badge variant="success">Beauty & Care</Badge>
          <Badge variant="warning">Home & Kitchen</Badge>
        </div>
      </div>
