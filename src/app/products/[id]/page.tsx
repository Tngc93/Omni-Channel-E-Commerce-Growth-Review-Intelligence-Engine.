    ...
    <div className="space-y-8 apple-bg-glow">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-4">
        <Card>
          ...
          <div className="mt-1 text-xl font-bold text-slate-900 dark:text-white font-mono">{formatCurrency(product.price)}</div>
        </Card>
        <Card>
          <span className="text-[11px] font-mono uppercase text-slate-500 dark:text-slate-400">İade Oranı</span>
          <div className="mt-1 text-xl font-bold text-rose-600 dark:text-rose-400 font-mono">{formatPercent(product.returnRate)}</div>
        </Card>
        <Card>
        ...
        <Card>
          ...
          <div className="mt-1 text-xl font-bold text-emerald-600 dark:text-emerald-400 font-mono">{product.reviews.length} Doğrulanmış</div>
        </Card>
      </div>
